                ...
                <form onSubmit={handleSaveSettings} className="space-y-6">
                    ...
                    <div className="admin-card p-6 space-y-4">
                        <div className="border-b border-gray-100 pb-3 flex items-center gap-2">
                            ...
                            <div>
                                <h3 className="text-base font-bold text-gray-800 font-outfit">Kehadiran TikTok</h3>
                                <p className="text-[10px] text-gray-400 mt-0.5">
                                    Tombol di hero beranda mengarah ke sini. Kalau ada Livestream aktif (menu Livestream) yang berupa TikTok Live, tombol otomatis menampilkan "LIVE di TikTok" dan mengarah ke link live itu — link di bawah ini hanya dipakai sebagai fallback saat sedang tidak live.
                                </p>
                            </div>
                        </div>

                        <div className="space-y-1">
                            <label className="text-xs font-semibold text-gray-400 uppercase">Link Profil TikTok</label>
                            <input
                                type="text"
                                value={data.tiktok_profile_url}
                                onChange={(e) => setData('tiktok_profile_url', e.target.value)}
                                placeholder="https://www.tiktok.com/@ilookfashion"
                                className="w-full bg-white border border-gray-200 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 text-sm rounded-xl px-4 py-2.5 text-gray-800"
                            />
                            {errors.tiktok_profile_url && <p className="text-xs text-red-500 mt-1">{errors.tiktok_profile_url}</p>}
                        </div>
                    </div>
